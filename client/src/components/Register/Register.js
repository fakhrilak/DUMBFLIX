...
const Register = ({ showModalRegister, modalRegister, handleRegister,showModalLogin }) => {
    ...
    <div>
      ...
      >
        <form onSubmit={(e) => onSubmit(e)}>
          <h1 style={{ marginLeft: "10px" }}>REGISTER</h1>
        ...
        <p style={{ color: "#B1B1B1", fontSize: "18px" ,textAlign:'center'}}>
          ...
          <span style={{ fontWeight: "900", cursor: "pointer" }} onClick={()=>showModalLogin()}>Here</span>
        </p>
      </Modal>
    </div>
  );
